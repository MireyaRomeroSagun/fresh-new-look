    ...
    <div className="flex flex-col flex-1 overflow-hidden">
      <header className="flex h-16 items-center border-b border-border bg-card px-6 shadow-sm shrink-0">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">Sesiones de Reuniones</p>
        </div>
      </header>
      <main className="flex-1 overflow-y-auto p-6">
        <div className="mx-auto max-w-lg">
          <div className="rounded-xl bg-card border border-border p-8 shadow-sm text-center">
            ...
            <h2 className="text-xl font-semibold text-foreground mb-2">Sesiones de Reuniones</h2>
...
export default SupportMeetingsSessions;
